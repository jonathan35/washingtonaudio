...
<div class="row text-center p-4 p-md-2" style=" background: rgb(150,150,150); background: linear-gradient(180deg, rgba(220,220,220,1) 0%, rgba(190,190,190,1) 80%);  color:#000; font-size:15px; box-shadow: 0 -2px 2px rgba(0,0,0,.2);">
    <div class="col-12 col-md-10 offset-md-1">
        ...
        <div class="row d-flex pt-4 pb-5 text-left" >
            ...
            <div class="col-12 col-md">
                ...
                <div class="row">                
                    ...
                    <div class="col-6 col-md-12 pt-1">
                        <a href="#<?php echo ROOT?>type/<?php echo $str_convert->to_url($type['category'])?>" style="color:#003e87; text-decoration:none;"><?php echo $type['category']?></a>
                    </div>
                    <?php }?>
            ...
            <div class="col-12 col-md">
                ...
                <div class="pb-1">
                    <a href="https://www.facebook.com/" target="_blank">
                        <img src="<?php echo ROOT?>images/facebook-f.svg" width="14px" style="margin:10px"></a>
                    <a href="https://wa.me/60168653957" target="_blank">
                        <img src="<?php echo ROOT?>images/whatsapp.svg" width="20px" style="margin:10px"></a>
                    <a href="#" target="_blank">
                    <img src="<?php echo ROOT?>images/instagram.svg" width="20px" style="margin:10px"></a>
                </div>
            ...
            <div class="col-12 col-md">
                ...
                <br><br>
                <div class="pb-1">
                <a href="https://www.google.com/maps/place/Washington+Audio/@1.5175374,110.3627953,17z/data=!3m1!4b1!4m5!3m4!1s0x31fba717c2313b5f:0x49d570dec075c958!8m2!3d1.517532!4d110.364984" target="_blank" style="color:#003e87;">
...
<div class="row" style="color:#FFF; font-size:15px; background:#777;">
