...
$table = 'driver';
$module_name = 'Driver (Delivery person)';
$php = 'driver';
$add = true;
$edit = true;
$list = true;
...
$fic_1 = array(0=>array('2', '0'));//fic = fiels in column, number of fields by column $fic_1 normally for add or edit template
...
$attributes['name'] = array('required' => 'required');
...
$type['group_id'] = 'select'; $option['group_id'] = array('1'=>'Master Driver', '2'=>'Store Driver');
...
*/
$cols = $items =array();
$cols = array('Driver' => '12');//Column title and width
$items['Driver'] = array('name');
