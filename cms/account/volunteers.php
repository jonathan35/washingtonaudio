...
$keywordFields=array("volunteer_name", "email");
...
$fields = array('id', 'volunteer_name', 'ic_passport', 'dob', 'religion', 'gender', 'race', 'address', 'email', 'mobile', 
				'programme', 'experience', 'experience_detail', 'illnesses', 'bankrupt', 'court', 'notify', 'created');
$value = array();
$type = array();
...
$fic_1 = array('9', '9');//fic = fiels in column, number of fields by column $fic_1 normally for add or edit template
...
*/
$cols = $items =array();
$cols = array('Volunteer' => '3', 'Email' => '3', 'Contact' => '3', 'Address' => '3');//Column title and width
$items['Volunteer'] = array('volunteer_name','gender');
$items['Email'] = array('email','created');
$items['Contact'] = array('mobile');
