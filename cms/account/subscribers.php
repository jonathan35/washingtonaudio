...
$keywordFields=array('email', 'username');
...
*/
$cols = $items =array();
$cols = array('Subscriber' => '8', 'Created Date' => '4');//Column title and width
$items['Subscriber'] = array('email');
$items['Created Date'] = array('created');
