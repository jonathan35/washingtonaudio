...
$fields = array('id', 'group_id', 'location', 'name', 'email', 'status', 'username', 'password');
$value = array();
$type = array();
...
$fic_1 = array(0=>array('5', '3'));//fic = fiels in column, number of fields by column $fic_1 normally for add or edit template
...
$type['group_id'] = 'select'; $option['group_id'] = array('1'=>'Master Admin', '2'=>'Store Admin');
...
$type['label'] = 'Location <br>(only for store admin)';
...
*/
$cols = $items =array();
$cols = array('Admin' => '3', 'Username' => '3', 'Email' => '4', 'Status' => '2');//Column title and width
$items['Admin'] = array('name');
