...
$fields = array('id', 'member', 'name', 'action', 'created');
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Member ID' => '2', 'Member Name' => '5', 'Action' => '2', 'Date & Time' => '3');//Column title and width
$items['Member ID'] = array('id');
$items['Member Name'] = array('name');
$items['Action'] = array('action');
$items['Date & Time'] = array('created');
