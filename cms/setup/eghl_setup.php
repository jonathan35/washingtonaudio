...
$fields = array('id', 'para2', 'para3', 'para4');
$value = array();
$type = array();
...
$label['para3'] = 'Merchant ID';
$label['para4'] = 'Merchant Password';
...
<div class="row">
	...
	<div class="col-12">
        ...
        <div class="col-12 col-md-4 card m-4 p-2 bg-secondary text-white">
        Testing account: sit<br>
        Password: sit12345
        </div>
	</div>
	<?php }?>
