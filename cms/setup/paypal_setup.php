...
$fields = array('id', 'para2', 'para3');//, 'para4', 'para5'
$value = array();
$type = array();
...
$fic_1 = array(0=>array('7'));//fic = fiels in column, number of fields by column $fic_1 normally for add or edit template
...
$label['para2'] = 'Server Type';
$label['para3'] = 'PayPal Account (Email)';
/*
...
*/
$cols = $items =array();
$cols = array('Region' => '2', 'Location' => '2');//Column title and width
...
<div class="row">
	...
	<div class="col-12">
		...
		<div class="col-12 col-md-5 card m-4 p-2 bg-secondary text-white">
			<h5>Test Merchant</h5>
			<div style="opacity:0.4">
				Use Testing merchant below when choose 'Testing Server' in CMS.
			</div>
			<div>
				Account: sb-zv43ii3073669@business.example.com	
			</div>
        </div>
		<div class="col-12 col-md-5 card m-4 p-2 pt-3 bg-secondary text-white">
			<h5>Payer</h5>
			<div style="opacity:0.4">
				Use Testing payer below when choose 'Testing Server' when checkout to PayPal.
			</div>
			<div>
				Account: sb-jkode3151267@personal.example.com
			</div>
			Password: l"Cc?sX5<br>
        </div>
	</div>
	<?php }?>
</div>
