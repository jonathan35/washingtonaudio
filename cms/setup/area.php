...
$table = 'area';
$module_name = 'Delivery Area & Price';
$php = 'area';
$add = true;
$edit = true;
$list = true;
...
$fields = array('id', 'region', 'location', 'area', 'price', 'position', 'status');
$value = array();
$type = array();
...
*/
$cols = $items =array();
$cols = array('Region' => '3', 'Location' => '3', 'Area' => '3', 'Position' => '3');//Column title and width
