...
$keywordFields=array('name', 'property', 'message');
$filter = false;
...
$fields = array('id', 'name', 'email', 'contact', 'property', 'date', 'message', 'status');
$value = array();
$type = array();
...
$cols = array('Name' => '2', 'Email/Contact' => '3', 'Property' => '5', 'Date' => '1', 'Status' => '1');//Column title and width
$items['Name'] = array('name');
$items['Email/Contact'] = array('email', 'contact');
$items['Date'] = array('date');
$items['Status'] = array('status');
$items['Property'] = array('property');
