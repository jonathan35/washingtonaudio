...
if($_SESSION['validation']=='YES'){
	...
	echo '<div style="margin-left:20%;">';
				...
				$bannerData['banner_file'] = 'file';
				$bannerData['position'] = '1';
				$bannerData['status'] = 1;
				$bannerData['text_content'] = 'aaa';

				//if(sql_save($conn,'banner',$bannerData)){
				//	echo 'banner true';
				//}else{
				//	echo 'banner false';
				//}
		...
		echo $xx = "INSERT INTO banner (banner_file, text_content, position, status) VALUES ('file','aaa','1','1')";
		//echo $xx = "INSERT INTO news (title) VALUES ('265')";
		
		$aaa = mysqli_query($conn,$xx);
...
//******************************************Add News*************************************************
	if($_POST['submit']==' Submit '){
		...
		$data['status'] = '1';
		$data['posting_date'] = date("Y-m-d", strtotime($_POST['posting_date']));
...
<link href="../css/dashboard.css<?php echo $version?>" rel="stylesheet">
<link href="../css/custom.css<?php echo $version?>" rel="stylesheet">

<script src="../css/jquery.js<?php echo $version?>"></script>
...
<link rel="stylesheet" href="<?php echo ROOT?>js/datepicker/jquery-ui.css<?php echo $version?>">
<link rel="stylesheet" href="<?php echo ROOT?>js/datepicker/style.css<?php echo $version?>">
...
<script>
$( function() {
    $( ".datepicker" ).datepicker({ /*minDate: +7, maxDate: "+6M +1D"*/ });
} );
</script>
