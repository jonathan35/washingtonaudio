...
$fields = array('id', 'developer_photo', 'position', 'status');
$value = array();
$type = array();
...
$attributes['developer_photo'] = array('required' => 'required');
$placeholder['title'] = 'Title for profile page';
//$placeholder['post_content'] = 'Description for profile page';

$type['id'] = 'hidden';
$type['developer_photo'] = 'image';
$remark['developer_photo'] = '<div><small class="text-muted" >Recommanded size: 200 x 100 pixel</small></div>';
