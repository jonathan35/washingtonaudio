...
$fields = array('id', 'banner', 'position', 'status', 'text_in_mobile', 'text_in_desktop');
$value = array();
$type = array();
...
$fic_1 = array(0=>array('2', '2'), 1=>array(1), 2=>array(1));//fic = fiels in column, number of fields by column $fic_1 normally for add or edit template
