<div id="editProfileAddressModal2" class="modal fade" role="dialog">
                    ...
                    <div class="pl-lg-5 pr-lg-5 pl-md-5 pr-md-5">
                        <div class="row p-4">
                            ...
                            <div class="col-12 form-group mb-4">
                                <label class="edit-delivery-label" for="area2">Area</label>
                                <select id="area2" name="area2" class="form-control signup-input" required>
                            ...
                            <div class="col-12 form-group mb-4">
                                <label class="edit-delivery-label" for="address2">Delivery Address</label>
                                <textarea class="form-control signup-input" id="address2" name="address2"
